    ...
    return (/*#__PURE__*/
      React.createElement(CarouselContext.Provider, {
        value: {
          ...
          canScrollPrev,
          canScrollNext
        }, "data-phoenix-id": "phoenix-7448bc59-1" }, /*#__PURE__*/
...
const CarouselContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { ref: carouselRef, className: "overflow-hidden", "data-phoenix-id": "phoenix-7448bc59-3" }, /*#__PURE__*/
      React.createElement("div", _extends({
        ref: ref,
        className: cn(
          "flex",
...
const CarouselPrevious = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement(ArrowLeft, { className: "h-4 w-4", "data-phoenix-id": "phoenix-7448bc59-7" }), /*#__PURE__*/
      React.createElement("span", { className: "sr-only", "data-phoenix-id": "phoenix-7448bc59-8" }, "Previous slide")
      ));
...
const CarouselNext = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement(ArrowRight, { className: "h-4 w-4", "data-phoenix-id": "phoenix-7448bc59-10" }), /*#__PURE__*/
      React.createElement("span", { className: "sr-only", "data-phoenix-id": "phoenix-7448bc59-11" }, "Next slide")
      ));
